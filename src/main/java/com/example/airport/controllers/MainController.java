...
//        Place p = placesRepo.findByName("Милан, Италия");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1MVT4lO3nX71pFdJJ9z4ENiaAqxbSWnI&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Париж, Франция");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=153CCX6kDdUQX_IwkTgbt1XbvDBo13BI&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Барселона, Испания");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1GuqTDfJxJX3aQQDxghoiLZy2cvHhZ1c&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Торонто, Канада");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1I0dc4w2V6JDXw2deQ1PC1TtyQqhIb9A&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Калифорния, США");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1HVnn0tTGU1d68mBwxhoDB0-psukiuqQ&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Магадан, Россия");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1UquuO6zudrQFwhwCAHcefSlKGSM0-c0&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Тбилиси, Грузия");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1pa_ZtntY_ltODTJc2PZKRqqYdu1vKtw&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Ташкент, Узбекистан");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1J-exs2sRXxjAZMUGZh5arBXNrV71eJU&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Варшава, Польша");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1K09TAMW7f_foVt-A9m5cCtWhPAFGrvE&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Рига, Латвия");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1W6k2uin3CGFZsap9w7cK5FxmkjFGnrA&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Вена, Австрия");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1A6mpZn1sro-UhSVCCS82SzZbcpdwBKI&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Вильнюс, Литва");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1-SZeUxYp3mLqFzA9XWemvGd3WYG_fdk&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Франкфурт, Германия");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1SP-vmhSAVvhUq2AEQMeT8eZdjK4j3Bs&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Амстердам, Нидерланды");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1SQoN3ITi8JamWq83z22di0NwZpWRgFE&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Брюссель, Бельгия");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1nFgWMSmzlfMLIZnePssrzz5dcHNnoH8&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Женева, Швейцария");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1gX-mU1JO4WiS7PbsRS0BQwd6dgeQigg&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Стамбул, Турция");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1-8pcza4g0c6KjTLGNrhhSVJCYTviZA8&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Киев, Украина");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1YTatEbhIdf5bDgkXmzru0DO0zCsttMQ&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Белград, Сербия");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1SqywWzNE19kpRQ5P2raOPnKi3q2baLM&ehbc=2E312F");
//        placesRepo.save(p);
//        p = placesRepo.findByName("Москва, Россия");
//        p.setCoordinates("https://www.google.com/maps/d/u/3/embed?mid=1Lh1mGhTSdqG95WHi6Qu7xDR1zq621dg&ehbc=2E312F");
//        placesRepo.save(p);
